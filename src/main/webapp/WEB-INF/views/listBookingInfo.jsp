		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="row">
						<a class="my-4 text-black" href="${pageContext.request.contextPath}/bookinginfos/create">Create
							new booking info</a>
								...
								<div class="card-body">
									<div class="table-responsive pt-3">
										<table class="table table-bordered">
											...
											<tbody>
												 <c:if test="${not empty bookinginfos}">
												    <c:forEach items="${bookinginfos}" var="bookinginfo" varStatus="index">
												        <tr>
												            <td><a href="#" data-toggle="modal" data-target="#updateModal-${bookinginfo.id}">${bookinginfo.booking.email}</a></td>
												            <td>${bookinginfo.seat.id}</td>
												            <td>
												            	<form id="deleteForm" method="post"
																action="${pageContext.request.contextPath}/bookinginfos/delete">
																<input type="hidden" name="id"
																	value="${bookinginfo.id }" />
																<button type="button" class="btn " data-toggle="modal"
																	data-target="#exampleModal-${bookinginfo.id }">
																	<i style="font-size: 30px;"
																		class="mdi mdi-delete-forever btn-icon "></i>
																</button>
																<div class="modal fade"
																	id="exampleModal-${bookinginfo.id }" tabindex="-1"
																	...
																	<div class="modal-dialog">
																		<div class="modal-content">
																			...
																			<div class="modal-body">Do you want to delete Booking Info?
																				${bookinginfo.booking.email } ?</div>
												            ...
												            <!-- Update Modal -->
												            <div class="modal fade" id="updateModal-${bookinginfo.id}" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
												                <div class="modal-dialog" role="document">
												                    <div class="modal-content">
												                        <div class="modal-header">
												                            <h5 class="modal-title" id="updateModalLabel">Update Booking Info</h5>
												                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
												                                <span aria-hidden="true">&times;</span>
												                            </button>
												                        </div>
												                        <form action="${pageContext.request.contextPath}/bookinginfos/update" method="post">
												                            <div class="modal-body">
												                                <input type="hidden" name="id" value="${bookinginfo.id}">
												                                ...
												                                <div class="form-group">
																					<label>Seat ID</label> <select class="form-control w-25"
																						name="seat.id">
