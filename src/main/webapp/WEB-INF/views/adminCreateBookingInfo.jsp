							...
							<div class="card">
								<div class="card-body">
									<form class="forms-sample" 
										method="post" action="${pageContext.request.contextPath}/bookinginfos/save" enctype="multipart/form-data">
										<div class="form-group">
											<label>Email Booking</label> <select class="form-control w-25"
												name="booking.id">
